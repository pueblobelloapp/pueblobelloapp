...
class _MsitiosTuristicoState extends State<MsitiosTuristico> {
    ...
    return Container(
        ...
        child: Form(
          ...
          children: <Widget>[
            ...
            textForm(_descripcionST, "Descripcion del sitio", 5, TextInputType.name),
            SizedBox(height: 15),
            Text(
              ...
              children: [
                TextButton(
                  onPressed: () {
                    ...
                    if(_nombreST.text.isEmpty || _capacidadST.text.isEmpty
                    || _tipoTurismo.text.isEmpty || _tipoTurismo.text.isEmpty
                    || _descripcionST.text.isEmpty || _ubicacionST.isEmpty
                    ){
  ...
  Widget ListTravel(TextEditingController _tipoTurismo, List<String> listTypeCulture) {
