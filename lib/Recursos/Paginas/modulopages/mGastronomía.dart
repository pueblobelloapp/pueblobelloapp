...
class Mgastronomia extends StatefulWidget {
  Mgastronomia({Key? key}) : super(key: key);

  @override
  State<Mgastronomia> createState() => _MgastronomiaState();
}

class _MgastronomiaState extends State<Mgastronomia> {
  @override
  ...
  Widget Formulario() {
    final _nombreG = TextEditingController();
    String _tipoTurismo = "";
    //File imagenG;
    final _capacidadG = TextEditingController();
    final _ubicacionG = TextEditingController();
    final _descripcionG = TextEditingController();
          ...
          children: <Widget>[
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          hintText: 'Nombre de la Gastronomía',
                          hintStyle: TextStyle(color: Colors.grey.shade300),
                          prefixIcon: Image(
                            image:
                                AssetImage('assets/icons/iconsEnsalada2.png'),
                          )
                          /*const Icon(
                            Icons.home_rounded,
                            color: Colors.blue,
            ...
            Container(
              ...
              child: DropdownButtonFormField<String>(
                  ...
                  hint: Text(
                    'Seleccione un tipo de gastronomía',
            ...
            Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  contentPadding: EdgeInsets.all(16.0),
                  fillColor: Colors.white,
                  hintText: 'Realize una pequeña descripción de la gastronomía',
                  hintStyle: TextStyle(color: Colors.grey.shade300),
                ),
                validator: (value) {
